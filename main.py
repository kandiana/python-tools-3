"""Вывод пройденной дистанции и сожженных калорий.

Модуль принимает пакеты со времением и числом шагов
и выводит суммаризацию о пройденной за день дистанции
и сожженных калориях
"""
...
def get_spent_calories(dist: float, current_time: dt._Time) -> float:
    ...
    return ((K_1 * WEIGHT + (mean_speed ** 2 // HEIGHT) * K_2 * WEIGHT)
            * time * 60)
